...
# ==============================================================================
# ZH: Notebook Schema | EN: Notebook Schemas
# ==============================================================================

class NotebookCell(BaseModel):
    """ZH: 單一 Notebook 格子 | EN: Single notebook cell"""
    id:      str                 # ZH: 格子唯一 ID（前端產生）| EN: Unique cell ID (generated by frontend)
    type:    str                 # ZH: "code" | "shell" | "markdown"
    content: str                 # ZH: 格子內容 | EN: Cell content


class NotebookSave(BaseModel):
    """ZH: 儲存 Notebook 請求 | EN: Save notebook request"""
    cells:       List[NotebookCell]    # ZH: 格子清單 | EN: Cell list
    environment: Dict[str, Any] = {}   # ZH: {framework, mode, preferred_node, docker_image, ...}


class NotebookResponse(BaseModel):
    """ZH: Notebook 查詢回應 | EN: Notebook query response"""
    model_config = ConfigDict(from_attributes=True)
