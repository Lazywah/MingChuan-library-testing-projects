...
def upgrade() -> None:
    ...
    @node job-scheduler/migrations/versions/9eed038079b0_initial_schema.py::upgrade
    """
...
def downgrade() -> None:
    ...
    @node job-scheduler/migrations/versions/9eed038079b0_initial_schema.py::downgrade
    """
    # ### commands auto generated by Alembic - please adjust! ###
    with op.batch_alter_table('training_jobs', schema=None) as batch_op:
