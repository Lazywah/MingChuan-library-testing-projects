...
(function () {
    ...
    function hhToStep(hm) {
        ...
        if (!m) return null;
        return Math.round((+m[1] * 60 + +m[2]) / 30);
    }
    ...
    function stepLabel(v) {                        // ZH: 顯示用（48 顯示 24:00）
        return +v === 48 ? '24:00'
    ...
    // ZH: v4.2 —— 「手動補齊點數」搬到 people.js（帳號頁的 MYAI 檢視，
    //     擁有者裁定 2026-09-02）。理由見 people.html 該區塊的註解。
