...
(function () {
    ...
    function renderMenu() {
        ...
        //
        // ZH: 🔴 路徑一定要帶 `/v2/`。port 80 的根路徑是 **Open WebUI**，
        //     完全不同的產品 —— 指到 `/` 會把人送到一個他沒有要去的地方。
        //     nginx 上三個版本各自有路徑：/train/（v1）、/v1.5/、/v2/。
        //     （管理端這一側也一樣：:8888/ 是 v1、:8888/v2/ 才是這一版。）
        var back = document.createElement('a');
        back.href = location.protocol + '//' + location.hostname + '/v2/';
