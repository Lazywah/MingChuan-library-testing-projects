...
const TRANSLATIONS = {
    zh: {
        lab_tips_summary: "使用說明與注意事項（4 則）",
        ql_section_title: "快速入口",
        ql_go_assistant: "開啟助手",
        ql_go_lab: "開啟 Lab",
        ql_go_docs: "開啟文件庫",
        btn_refresh: "重新整理",
        btn_quick_tutorial: "快速教學",
        ph_task_name: "輸入任務名稱…",
        ph_chat_message: "在這裡輸入訊息…",
        aria_font_size: "字體大小",
        aria_send: "送出訊息",
        login_title: "系統登入",
        ...
        ql_lab_desc: "瀏覽器裡的 VS Code，可直接送 GPU 執行",
        anno_loading: "載入公告中...",
        anno_empty: "目前沒有公告",
    ...
    en: {
        lab_tips_summary: "Notes & tips (4)",
        ql_section_title: "Quick Links",
        ql_go_assistant: "Open Assistant",
        ql_go_lab: "Open Lab",
        ql_go_docs: "Open Docs",
        btn_refresh: "Refresh",
        btn_quick_tutorial: "Quick Tutorial",
        ph_task_name: "Enter task name…",
        ph_chat_message: "Type your message here…",
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // v2.3: 字體大小 slider / reset 綁定
        // ZH: v1.5 —— 整張快速入口卡可點，不是只有那顆按鈕。
    //     使用者的直覺是「點那個東西」，不是「找到那個東西裡面的按鈕再點」；
    //     按鈕留著是給鍵盤操作與明確的視覺提示（Fitts 法則：目標越大越好按）。
    document.querySelectorAll('.quick-link-card').forEach(card => {
        card.addEventListener('click', (e) => {
            if (e.target.closest('button')) return;   // 按鈕自己會處理，別觸發兩次
